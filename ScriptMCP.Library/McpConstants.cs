...
public static class McpConstants
{
    ...
    public const string Instructions =
        ...
        "The task runs via --exec-out. By default it writes each execution result to a timestamped file in output; with append=true it uses --exec-out-append and appends to <function>.txt. " +
