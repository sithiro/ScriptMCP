...
public static class McpConstants
{
    public const string Instructions =
        ...
        "- read_scheduled_task: Reads the most recent scheduled-task output file for a specific function from the exec-out directory beside the database. " +
        ...
        "The task runs via --exec-out. By default it writes each execution result to a timestamped file in exec-out; with append=true it appends to <function>.txt. " +
