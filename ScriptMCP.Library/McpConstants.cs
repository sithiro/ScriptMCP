...
public static class McpConstants
{
    public const string Instructions =
        ...
        "The task runs via --exec_out. By default it writes each execution result to a timestamped file in scheduled_task_out; with append=true it appends to <function>.txt. " +
