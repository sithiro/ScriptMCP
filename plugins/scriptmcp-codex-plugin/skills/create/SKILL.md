...
8. If the script needs shared helper code from `.csx` files, add `#load "path.csx"` directives at the top of the body (loaded files must contain classes/structs, not bare top-level statements)
